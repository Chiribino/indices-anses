...
def leer_archivo_indices(archivo='indices.json'):
    ...
    return {
        ...
        # 'rentas_de_referencia': datos['rentas_de_referencia'],
...
def actualizar_indices(archivo='indices.json'):
    try:
        ...
        # print("\nRENTAS_DE_REFERENCIA:")
        # for categoria in diccionarios['rentas_de_referencia']:
        #     valor_anterior = diccionarios['rentas_de_referencia'][categoria][ultimo_mes]
        #     nuevo_valor = round(valor_anterior * indice, 2)
        #     diccionarios['rentas_de_referencia'][categoria][siguiente_mes] = nuevo_valor
        #     print(f"  Categoría {categoria}: {nuevo_valor}")
        ...
        print(
            f"Archivo indices.json actualizado exitosamente con los valores para {siguiente_mes}")
